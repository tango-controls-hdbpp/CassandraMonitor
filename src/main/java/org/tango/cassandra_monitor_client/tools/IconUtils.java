...
public class IconUtils implements IConstants {
    ...
    private static ImageIcon compaction = null;

    private static final IconUtils instance = new IconUtils();
    private static final String ImagePath = "/cassandra_monitor/icons/";
    //===============================================================
    //===============================================================
    ...
    //===============================================================
    //===============================================================
    public static ImageIcon getCompactionIcon() {
        return initializeIconSafe(compaction, "greenBall.gif", 0.75);
    }
    //===============================================================
    //===============================================================
    ...
    //===============================================================
    //===============================================================
    private static ImageIcon initializeIconSafe(ImageIcon icon, String fileName, double ratio) {
        try {
            if (icon==null)
                icon = getInstance().getIcon(fileName, ratio);
        }
        catch (DevFailed e) {
